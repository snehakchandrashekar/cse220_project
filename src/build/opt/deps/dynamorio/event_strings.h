...
#define MSG_FAILED_TO_HANDLE_SIGNAL_STRING "Application %s (%s). Cannot correctly handle received signal %s in thread %s: %s."
#define MSG_FAILED_TO_TAKE_OVER_THREADS_STRING "Application %s (%s). Failed to take over all threads after multiple attempts."
#define MSG_THREAD_TAKEOVER_TIMED_OUT_STRING "Application %s (%s). Timed out attempting to take over one or more threads. %s"
...
#define MSG_INJECTION_LIBRARY_MISSING_STRING "Application %s (%s). The library %s for child process injection is missing."
#define MSG_FOLLOW_CHILD_FAILED_STRING "Application %s (%s). Failed to follow into child process: %s."
#define MSG_STANDALONE_ALREADY_STRING "Application %s (%s). Standalone mode is in progress: cannot switch to full mode."
